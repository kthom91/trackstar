  ...
  template: `
    <div class="max-w-5xl mx-auto space-y-8 animate-fadeIn">
      ...
      <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-950/80 via-purple-950/60 to-pink-950/60 border border-indigo-500/30 p-8 sm:p-10 shadow-2xl backdrop-blur-xl">
        <div class="relative z-10 max-w-2xl space-y-3">
          ...
          <p class="text-sm sm:text-base text-gray-300 leading-relaxed">
            Your personal data repository is ready. Follow this quick setup guide to install the Letterboxd Chrome sync extension, import your reading and film history, and connect your live concert records.
          </p>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <!-- STEP 4: setlist.fm Live Concerts -->
        <div class="bg-[#131b2e]/70 border border-white/10 rounded-3xl p-6 sm:p-7 space-y-5 backdrop-blur-xl hover:border-emerald-500/40 transition-all flex flex-col justify-between shadow-xl">
          <div class="space-y-4">
            <div class="flex items-center justify-between">
              <span class="w-8 h-8 rounded-xl bg-emerald-600 text-white font-black text-xs flex items-center justify-center shadow-lg shadow-emerald-600/30">
                04
              </span>
              <span class="px-2.5 py-0.5 rounded-md bg-emerald-500/10 text-emerald-300 text-[11px] font-semibold uppercase tracking-wider border border-emerald-500/20">
                setlist.fm
              </span>
            </div>

            <div>
              <h3 class="text-lg font-bold text-white font-['Outfit']">Sync Attended Concerts</h3>
              <p class="text-xs text-gray-400 mt-1 leading-relaxed">
                Connect your setlist.fm account to sync all past live concerts, dates, venues, setlists, and band artwork.
              </p>
            </div>
            ...
            <div class="bg-[#0b0f19] border border-white/5 rounded-2xl p-4 space-y-2.5 text-xs text-gray-300">
              <div class="flex items-start space-x-2">
                ...
                <span>Generate a free key at <a href="https://www.setlist.fm/settings/api" target="_blank" rel="noopener noreferrer" class="text-emerald-400 hover:underline">setlist.fm/settings/api ↗</a></span>
              </div>
              <div class="flex items-start space-x-2">
                <span class="text-emerald-400 font-bold">2.</span>
                <span>Paste your username and API key into Trackstar (saved in your local browser).</span>
              </div>
              <div class="flex items-start space-x-2">
                <span class="text-emerald-400 font-bold">3.</span>
                <span>Click <strong class="text-white">Sync Attended Concerts</strong> to ingest your shows.</span>
              </div>
            </div>
          </div>
          ...
          <div class="pt-2">
            <a routerLink="/importers"
               class="w-full py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold transition-all flex items-center justify-center space-x-2 shadow-lg shadow-emerald-600/25">
              <span>Open setlist.fm Connector →</span>
            </a>
          </div>
        </div>
...
export class GetStartedComponent {
  ...
  copied = false;
  extensionPath = 'tools/browser-extension';

  copyPath() {
    navigator.clipboard.writeText('/Users/kenny/Documents/GitHub/trackstar/tools/browser-extension');
    this.copied = true;
